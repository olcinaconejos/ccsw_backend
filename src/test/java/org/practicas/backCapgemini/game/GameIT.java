package org.practicas.backCapgemini.game;
...
public class GameIT {
    ...
    private String getUrlWithParams() {
        return UriComponentsBuilder.fromUriString(LOCALHOST + port + SERVICE_PATH).queryParam(TITLE_PARAM, "{" + TITLE_PARAM + "}").queryParam(CATEGORY_ID_PARAM, "{" + CATEGORY_ID_PARAM + "}").encode().toUriString();
    }
